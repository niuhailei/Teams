...
- (void)addAllViews{
    ...
    self.finishBtn.frame = CGRectMake(kWidth*0.7, kHeight*0.8,  kWidth*0.2, kWidth*0.15);
    [self.finishBtn setTitle:@"完成" forState:UIControlStateNormal];
    [self addSubview:self.finishBtn];
    
    self.datePicker = [[UIDatePicker alloc]initWithFrame:CGRectMake(0, kHeight*0.3, kWidth, kWidth*0.8)];
